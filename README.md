...
<head>
    ...
    <title>AI 동료, 새로운 차원의 업무 혁신을 경험하세요</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300;400;500;700;900&family=Orbitron:wght@400;500;700;900&display=swap" rel="stylesheet">
    <style>
        :root {
            --mystic-bg: #0F0F1A; /* Deep, dark space blue */
            --mystic-primary: #6A0DAD; /* Vibrant Purple */
            --mystic-secondary: #00BFFF; /* Deep Sky Blue */
            --mystic-accent: #FF00FF;   /* Magenta for highlights */
            --mystic-text-light: #E0E0FF; /* Light, slightly bluish text */
            --mystic-text-dark: #1A1A2E;
            --mystic-card-bg: rgba(26, 26, 46, 0.8); /* Semi-transparent dark card */
            --mystic-border: rgba(106, 13, 173, 0.5); /* Purple border */
        ...
        body::before {
            ...
            height: 100%;
            background-image:
                radial-gradient(circle at 20% 20%, rgba(106, 13, 173, 0.15) 0%, transparent 40%),
                radial-gradient(circle at 80% 70%, rgba(0, 191, 255, 0.15) 0%, transparent 40%);
            animation: animateStars 120s linear infinite, subtleShine 10s ease-in-out infinite alternate;
            z-index: -1;
        }
...
<body class="antialiased">
    ...
    <section class="hero-section-mystic">
    ...
    <div id="tools" class="content-wrapper-mystic pt-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div class="mystic-card card-notebooklm animate-on-scroll" style="transition-delay: 0.2s;">
                <div class="mystic-card-header">
    ...
    <section id="synergy" class="synergy-section-mystic animate-on-scroll">
